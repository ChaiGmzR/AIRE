...
{
    private const string ProductName = "Ilsan Packing System";
    private const string DisplayVersion = "1.2.2";
    private const string ArchiveResource = "AIRE_1.2.2_windows.zip";
    ...
    private static int Main(string[] args)
    {
        if (args.Any(argument => string.Equals(argument, "--update", StringComparison.OrdinalIgnoreCase)))
        {
            ...
            {
                ShowMessage($"No se pudo actualizar AIRE 1.2.2.\n\n{error.Message}", "AIRE 1.2.2");
                return 1;
            }
        }
    ...
    private sealed class InstallerForm : Form
    {
        ...
        public InstallerForm()
        {
            ...
            var description = new Label
            {
                ...
                Text = "Ilsan Packing System se instalara en este equipo.\nLa aplicacion tambien quedara disponible desde el Menu Inicio.",
            };
    ...
    private static class InstallerCore
    {
        ...
        internal static void Install(Action<string>? report)
        {
            ...
            CreateShortcuts();
            RegisterUninstall();
            report?.Invoke("Iniciando aplicacion...");
