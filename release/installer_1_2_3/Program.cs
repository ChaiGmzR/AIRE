...
internal static class Program
{
    ...
    private const string DisplayVersion = "1.2.3";
    private const string ArchiveResource = "AIRE_1.2.3_windows.zip";
    ...
    private static int Main(string[] args)
    {
        if (args.Any(argument => string.Equals(argument, "--update", StringComparison.OrdinalIgnoreCase)))
        {
            ...
            {
                ShowMessage($"No se pudo actualizar AIRE 1.2.3.\n\n{error.Message}", "AIRE 1.2.3");
                return 1;
            }
        }
